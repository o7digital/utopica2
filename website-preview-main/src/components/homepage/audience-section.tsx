...
const forYou = [
  ...
  "Sabes que tu servicio es bueno, pero tus ventas no lo reflejan",
  "Estás dispuesto a invertir en resolver el problema de raíz",
];

const notForYou = [
  "Vendes productos físicos o commodities",
  "Tu venta es transaccional",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Para quién es <span className="font-serif italic">Utópica</span>
          </h2>
        </motion.div>
