...
export function ReunionesHero() {
  ...
  return (
    <section
      ...
      aria-labelledby="reuniones-hero-title"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        ...
        >
          <motion.h1
            id="reuniones-hero-title"
            className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            <span className="block">Esperar referidos no es estrategia.</span>
            <span className="block mt-2 text-primary">Es esperanza.</span>
          </motion.h1>
          ...
          >
            Un flujo constante de reuniones con decisores calificados. Sin que tú prospectes.
          </motion.p>
          ...
          >
            <TrackedCTAButton
              href={ctaUrl}
              target="_blank"
              trackingLocation="reuniones_hero"
              size="lg"
